...
public static class DatabaseConfiguration
{
    ...
    public static class DefaultConnectionStrings
    {
        ...
        public static string SqlServerLocalDb =>
            "Server=(localdb)\\mssqllocaldb;Database=ShoplazzaAddonFunctions;Trusted_Connection=true;MultipleActiveResultSets=true";

        /// <summary>
        /// Default SQLite connection string for development/POC
        /// </summary>
        public static string Sqlite =>
            "Data Source=shoplazza_addon_functions.db";
